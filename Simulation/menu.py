...
class Menu:
    def __init__(self):
        ...
        self.police = pygame.font.Font(None, 24)  # Taille de la police réduite

        # Champs de texte
        self.champs_texte = [pygame.Rect(300, 50 + i * 50, 300, 30) for i in range(10)]
    ...
    def afficher_texte(self, texte, x, y, taille=36):
        fonte_texte = pygame.font.Font(None, taille)
    ...
    def afficher_formulaire(self, variables):
        pygame.init()
        self.afficher_image_de_fond("image2.jpg")
        ...
        for i, (variable, champ) in enumerate(zip(variables, self.champs_texte)):
            ...
            surface_texte = self.police.render(self.textes_champs[i], True, self.NOIR)
            largeur_texte = max(200, surface_texte.get_width() + 10)
            champ.w = largeur_texte
            self.fenetre.blit(surface_texte, (champ.x + 5, champ.y + 5))

            # Bouton de retour
            self.dessiner_bouton(self.ROSE, 600, 500, 100, 30, "Retour")
    ...
    def menu_principal(self):
        while True:
            ...
            self.afficher_image_de_fond("image.jpg")
